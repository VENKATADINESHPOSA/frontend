              ...
              >
                <div style={{ height: 460, backgroundColor: "#f1f1f9" }}>
                  <Col sm={5} style={{ float: "left", paddingLeft: 35 }}>
                    <h2
                      ...
                      className="slider_text staggered-animation"
                    >
                      {" "}
                      Diverse{" "}
                    </h2>
                    <h5
                      ...
                      className="mb-3 mb-sm-4 slider_text1 font-weight-light"
                    >
                      Serving Across Indian
                      <span className="text_default">
                        {" "}
                        Industry since decades
                      </span>
                    </h5>
                  </Col>
                  ...
                  <Col sm={7} style={{ float: "left" }}>
                    <div>
                      <img
                        style={{ width: 700, height: 410, marginTop: 20 }}
                        src={BannerSlider1}
                      />
                    </div>
                  </Col>
                ...
                <div style={{ height: 460, backgroundColor: "#f1f1f9" }}>
                  <Col sm={5} style={{ float: "left", paddingLeft: 35 }}>
                    <h2
                      data-animation="slideInLeft"
                      data-animation-delay="30s"
                      className="slider_text slide_text staggered-animation"
                    >
                      {" "}
                      Range{" "}
                    </h2>
                    ...
                    >
                      Widest Range of{" "}
                      <span className="text_default"> Industrial Bearings</span>
                    </h5>
                  </Col>
                  ...
                  <Col sm={7} style={{ float: "left" }}>
                    <div>
                      <img
                        style={{ width: 720, height: 440, marginTop: 8 }}
                        src={BannerSlider2}
                      />
                    </div>
                  </Col>
                ...
                <div style={{ height: 460, backgroundColor: "#f1f1f9" }}>
                  <Col sm={5} style={{ float: "left", paddingLeft: 35 }}>
                    ...
                    <h5
                      ...
                      data-animation-delay="1s"
                    >
                      Big Applications need Big Bearings
                    </h5>
                  </Col>
                ...
                <div style={{ height: 460, backgroundColor: "#f1f1f9" }}>
                  <Col sm={5} style={{ float: "left", paddingLeft: 35 }}>
                    <h2
                      data-animation="slideInLeft"
                      data-animation-delay="1s"
                      className="slider_text staggered-animation  animated slideInLeft"
                    >
                      {" "}
                      Fake{" "}
                    </h2>
                    <h5
                      style={{ textAlign: "left" }}
                      className="mb-3 mb-sm-4 staggered-animation font-weight-light animated slideInLeft"
                      data-animation="slideInLeft"
                      data-animation-delay="1s"
                    >
                      Beware of Fake ZWZ bearings{" "}
                    </h5>
                  </Col>
              ...
              <Tabs>
                ...
                <TabPanel>
                  ...
                  >
                    <div style={{ width: "100%", textAlign: "center" }}>
                      <p className="para">
                        {" "}
                        ZWZ Introduces MB Type Spherical Roller Bearings{" "}
                      </p>
                    </div>
                    ...
                    >
                      {Images.new_product.map((item, index) => (
                        <div
                          ...
                          style={{ width: 285.5, marginRight: 20 }}
                        >
                          <div className="item">
                ...
                <TabPanel>
                  ...
                  >
                    <div style={{ width: "100%", textAlign: "center" }}>
                      <p className="para">
                        Use the industry best cylindrical roller bearings
                      </p>
                    </div>
                ...
                <TabPanel>
                  ...
                  >
                    <div style={{ width: "100%", textAlign: "center" }}>
                      <p className="para">
                        We have special offer for certain product groups used in
