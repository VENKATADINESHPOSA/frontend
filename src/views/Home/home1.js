            ...
            <Col sm={12}>
              <Carousel style={{ height: 80 }} showThumbs={false}>
                <div style={{ height: 440 }}>
                  ...
                  <p className="legend">
                    Find all the functions for your purchasing process{" "}
                  </p>
  ...
  <div>
            ...
            <Col sm={3} style={{ marginTop: 10 }}>
              <Card>
                ...
                />
                <CardBody style={{ backgroundColor: "#f4f4f4 !important" }}>
                  <CardTitle style={{ color: "#428bca" }}>
                    SS Round Shape Ball Bearing
                  </CardTitle>
                </CardBody>
              </Card>
            </Col>
            ...
            <Col
              sm={3}
              style={{ marginTop: 10 }}
              onClick={this.redirectProductCategory}
            >
              <Card>
                <CardImg
                  style={{
            ...
            <Col sm={12} style={{ marginTop: 40, textAlign: "center" }}>
              <h2 style={{ fontWeight: "bold", color: "#00619F" }}>
                {" "}
                Features on {Name}.Com{" "}
              </h2>
            </Col>

            <Col
              sm={4}
              style={{ marginTop: 10, height: 280, marginBottom: 20 }}
              onClick={this.redirectProductCategory}
            >
            ...
            <Col sm={4} style={{ marginTop: 25 }}>
              <h5 style={{ marginBottom: 12, fontWeight: "bold" }}>
                {" "}
                New Products{" "}
              </h5>
              ...
              <p style={{ marginTop: 15 }}>
                {" "}
                The latest innovations that help keep your business running
                smoothly.{" "}
              </p>
            </Col>
            ...
            <Col sm={4} style={{ marginTop: 25 }}>
              ...
              <p style={{ marginTop: 15 }}>
                Budget-saving deals on top products you use every day.{" "}
              </p>
            </Col>
            ...
            <Col sm={4} style={{ marginTop: 25 }}>
              ...
              <p style={{ marginTop: 15 }}>
                Hurry and save big on high-quality, limited-quantity items.{" "}
              </p>
            </Col>
