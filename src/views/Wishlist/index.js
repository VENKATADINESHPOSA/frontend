...
class Wishlist extends Component {
	...
	componentWillMount(){
		...
		var ProductVal = sessionStorage.getItem('product-val');
			...
			<div>
				...
				<div className="content-container wrapper">
					<Row>
						...
						<Col sm={3} style={{marginTop: 15, marginBottom:5}}>
							 <Card>
						        <CardBody className="customise_card_body" style={{padding: 18}}>
						          	<CardTitle style={{marginBottom: 20}}>
						          		<div>
						          			<span style={{color: '#00739E', fontWeight: 'bold', fontSize: 15}}> ZWZ </span> <br />
						          			<span style={{color: '#00739E', fontWeight: 'bold', fontSize: 14}}> 6205n, Cylindrical Roller, TVM </span> <br/>
						          			<span style={{fontSize: 14}}> Qty | 12 </span> <br/>
						          			<span style={{fontSize: 14}}> 2800 <img style={{width: 10, height: 10}} src={Currency} /> </span> <br/>
						          			<span style={{fontSize: 14}}> <strong style={{fontSize: 14, fontWeight: 'bold'}}>Delivered  </strong> (Jul 15, 2019)  </span> <br/> <br/>
						          			<span className="item-action" style={{fontSize: 14}}> <button className="button" type="button">Track Order</button>  </span>
						          		</div>
						          	</CardTitle>
