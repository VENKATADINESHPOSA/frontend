...
class Login extends Component {
	...
	DisplayAddItem(){
		...
		axios.get(baseUrl+'/api/display_additem/' , 
	...
	componentWillMount() {
		...
		if (window.location.href === 'http://nod.prtouch.com:8081/login' || window.location.href === 'http://localhost:3000/login') {
    ...
    async onLogin(e) {
		...
		} else if(window.location.href === "http://nod.prtouch.com:8081/login#" || window.location.href === "http://localhost:3000/login#"   || window.location.href === "http://nod.prtouch.com:8081/login" ){
					...
					<Row>
						...
						<Col sm={12} xs={12} md={12} lg={12} className="login_subtitle_container">
							<div className="login_detail_container">
								...
								<input type = "text" onChange={this.handleChange} style={{marginBottom: 6}} name="username"  placeholder="Email" />
								{
									this.state.showError1 &&
									<div style={{width: '100%', textAlign: 'left'}}>
										<span style={{color: 'red', fontSize: 11}}> Please Enter Username </span>
									</div>	
								}
								
								<input type = {this.state.passowrdType} style={{marginTop: 25, marginBottom: 0}} onChange={this.handleChange} name="password" placeholder="Password" />

								{
									this.state.showError2 &&
									<div style={{width: '100%', textAlign: 'left'}}>
										<span style={{color: 'red', fontSize: 11}}> Please Enter Password </span>
									</div>	
								}
								...
								<Row>
									<Col sm={12} xs={12} md={12} lg={12} className="checkbox_main_container">
										...
										<Col sm={6} xs={6} md={6} lg={6} className="right_container">
											<a href="#" onClick = { this.onClickFrgtpass }> Forgot Password? </a>
								...
								<input onClick = { this.onLogin } disabled={!this.state.captchaVerified} type="button" value="Login" className={`login_btn ${!this.state.captchaVerified ? 'disabled' : ''}`} />
