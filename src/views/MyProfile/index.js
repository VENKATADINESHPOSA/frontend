...
class MyProfile extends Component {
  ...
  storedeliveryaddress(e) {
    ...
    if (
      ...
      url = zwzapiurl + "authentication/user/createDeliveryAddress/";
    } else if (
  ...
  changeBillingState(e) {
    ...
    if (
      ...
      url = zwzapiurl + "authentication/city_list/";
    } else if (
      window.location.href === "https://localhost:3000/my-profile" ||
      window.location.href === "https://localhost:3000/my-profile#" ||
      window.location.href === "https://store.nodbearings.net/my-profile" ||
      ...
      url = "https://api.store.nodbearings.net/authentication/city_list/";
    } else {
      url = zwzapiurl + "authentication/city_list/";
    }
    axios
      ...
      .then((response) => {
        if (response.data.success === true) {
          cogoToast.success(response.data.message);
          this.setState({
            cityOption: response.data.data.map((data) => (
  ...
  updateBillingInformation(e) {
    ...
    if (
      ...
      billing_url = zwzapiurl + "authentication/update_get_info/";
    } else if (
      window.location.href === "https://store.nodbearings.net/my-profile" ||
      window.location.href === "https://store.nodbearings.net/my-profile#" ||
      window.location.href === "https://localhost:3000/my-profile" ||
  ...
  updateProfileInformation(e) {
    ...
    if (
      ...
      url = zwzapiurl + "authentication/update_get_info/";
    } else if (
      window.location.href === "https://localhost:3000/my-profile" ||
      window.location.href === "https://localhost:3000/my-profile#" ||
      window.location.href === "https://store.nodbearings.net/my-profile" ||
      ...
      url = "https://api.store.nodbearings.net/authentication/update_get_info/";
    } else {
      url = zwzapiurl + "authentication/update_get_info/";
    }
    /*if(window.location.href === zwzurl + "my-profile" || window.location.href === zwzurl + "my-profile#" || window.location.href === "https://localhost:3000/my-profile" || window.location.href === "https://localhost:3000/my-profile#") {*/
    ...
    /*}else if (window.location.href === "https://store.nodbearings.net/my-profile" || window.location.href === "https://store.nodbearings.net/my-profile#") {

			axios.post('https://api.store.nodbearings.net/authentication/update_get_info/' , 
      ...
      <div>
        ...
        >
          ...
          <Row>
            ...
            {this.state.updateButton && (
              <Col sm={12} style={{ marginTop: 5, textAlign: "center" }}>
                <input
                  style={{ width: 240 }}
                  type="button"
                  onClick={(e) => {
                    this.updateProfileInformation(e);
                  }}
          ...
          <Row>
            ...
            {this.state.updateBillingInformation && (
              <Col sm={12} style={{ marginTop: 5, textAlign: "center" }}>
                <input
                  style={{ width: 240 }}
                  type="button"
                  onClick={(e) => {
                    this.updateBillingInformation(e);
                  }}
                  ...
                  >
                    <Row>
                      {this.state.billingaddress == item.add_details ? (
                        ...
                        <Col
                          sm={12}
                          style={{ marginTop: 6, paddingLeft: 25 }}
                        ></Col>
                      )}
        ...
        <Modal isOpen={Successmodal} toggle={this.Successtoggle}>
          ...
          <div className="modal__body" style={{ padding: 12 }}>
            ...
            <div style={{ width: "20%", float: "left", textAlign: "left" }}>
              <span
                style={{ fontWeight: "bold", fontSize: 16, textAlign: "left" }}
              >
                {" "}
                Pincode:{" "}
              </span>
          ...
          >
            <ButtonToolbar className="modal__footer">
              ...
              <Button
                ...
                className="modal_ok"
                onClick={this.storedeliveryaddress}
              >
