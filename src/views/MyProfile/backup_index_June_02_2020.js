...
class MyProfile extends Component {
	...
	async statelist(e){	
		...
		} else if(window.location.href === "http://store.nodbearings.net/signup#" || window.location.href === "http://store.nodbearings.net/signup" || window.location.href === "http://localhost:3000/login#" || window.location.href === "http://localhost:3000/login"){
						        	...
						        	<Row>
						        		<Col sm={12} style={{marginTop: 6}}>
								          ...
								          <Col sm={4} style={{ float: 'left'}}>
								          	<input type="text" className="address_input" defaultValue ={this.state.gstNumber} onChange={this.changeGST} placeholder="Enter GST Number" />
								          ...
								          <Col sm={2} style={{ float: 'left'}}>
								           ...
								           <Col sm={4} style={{ float: 'left'}}>
								          	<input type="text" defaultValue ={this.state.companyName} onChange={this.changeCompany} className="address_input" placeholder="Enter Company Name" />
								          	{
												this.state.error2 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
						        		...
						        		<Col sm={12} style={{marginTop: 6}}>
								          ...
								          <Col sm={4} style={{float: 'left'}}>
								          	<input type="text"  defaultValue ={this.state.name} onChange={this.changeName}  className="address_input" placeholder="Name" />
								          	{
												this.state.error3 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
								           ...
								           <Col sm={4} style={{ float: 'left'}}>
								          	<input type="text"  defaultValue ={this.state.mobileNo} onChange={this.changeMobile}  className="address_input" placeholder="Mobile No." />
								          	{
												this.state.error4 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
						        ...
						        <CardBody className="customise_card_body" style={{padding: 18}}>
						        	<Row>
						        		...
						        		<Col sm={12} style={{marginTop: 6}}>
								          ...
								          <Col sm={4} style={{ float: 'left'}}>
								          	<input type="text" onChange={this.changeBillingAddress} className="address_input" defaultValue ={this.state.billingaddress} placeholder="Enter Address" />
								          	{
												this.state.error5 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
								          ...
								          <Col sm={2} style={{ float: 'left'}}>
								           ...
								           <Col sm={4} style={{ float: 'left'}}>
								          	<select className="form-control" name="state" value = {this.state.billingstate} onChange={this.changeBillingState}>
						        		...
						        		<Col sm={12} style={{marginTop: 6}}>
									        ...
									        <Col sm={4} style={{float: 'left'}}>
									          	<select className="form-control" name="city" value = {this.state.billingcity} onChange={this.changeBillingCity}>
												   <option value={this.state.billingcity} style={{fontWeight: 'bold'}}>{this.state.billingcity}</option>	
									        ...
									        <Col sm={4} style={{float: 'left'}}>
									          	<input type="text"  defaultValue ={this.state.billingpincode} onChange={this.changeBillingPincode}  className="address_input" placeholder="Enter Pincode" />
									          	{
												this.state.error6 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
						        ...
						        <CardBody className="customise_card_body" style={{padding: 18}}>
						        	<Row>
						        		...
						        		<Col sm={12} style={{marginTop: 6}}>
								          ...
								          <Col sm={4} style={{ float: 'left'}}>
								          	<input type="text" className="address_input" onChange={this.changeShippingAddress} defaultValue ={this.state.shippingaddress} placeholder="Enter Address" />
								          	{
												this.state.error7 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
								          ...
								          <Col sm={2} style={{ float: 'left'}}>
								           ...
								           <Col sm={4} style={{ float: 'left'}}>
								          	...
								          	<select className="form-control" name="state" value = {this.state.shippingstate} onChange={this.changeShippingState}>
						        		...
						        		<Col sm={12} style={{marginTop: 6}}>
						        			<Col sm={2} style={{ float: 'left'}}>
								          	...
								          	<Col sm={4} style={{float: 'left'}}>
								          		...
								          		<select className="form-control" name="city" value = {this.state.shippingcity} onChange={this.changeShippingCity}>
												   <option value={this.state.shippingcity} style={{fontWeight: 'bold'}}>{this.state.shippingcity}</option>	
												   {this.state.city_options}
												</select>
								          	</Col>
								          	...
								          	<Col sm={4} style={{float: 'left'}}>
								          		<input type="text"  defaultValue ={this.state.shippingpincode} onChange={this.changeShippingpincode}  className="address_input" placeholder="Enter Pincode" />
								          		{
												this.state.error8 &&
												<div style={{width: '100%', textAlign: 'left'}}>
													<span style={{color: 'red', fontSize: 11}}> {this.state.errorMessage} </span>
