  ...
  addItem(data) {
    ...
    if (this.props.isLoggedIn) {
      ...
      let itemExist = _.find(
        this.props.cart,
        (item) => item.itemcode === data.itemcode[0]
      );
        ...
        (<span> Hello </span>),
        {
          image: (
            <div
              ...
              onClick={() => this.goToProductDetail(postVal)}
            >
              <div style={{ paddingBottom: 10 }}>
                ...
                >
                  {" "}
                  {postVal.itemname[0]} ({postVal.brandname[0]}){" "}
                </span>
              </div>{" "}
              <div>
                {" "}
          ...
          item_name: (
            <div style={{ flexDirection: "column", paddingTop: 32 }}>
              {" "}
              <div>
                {" "}
                <span>
              ...
              <div>
                ...
                <span>
                  ...
                  <span
                    style={{
                      color: postVal.Availability == "Stock" ? "green" : "red",
                      fontWeight: "bold",
                    }}
                  >
                    {postVal.Availability}
                  </span>{" "}
                </span>
              </div>{" "}
            </div>
          ...
          add_cart: (
            <div style={{ flexDirection: "column", paddingTop: 30 }}>
              ...
              <input
                type="text"
                onChange={(e) =>
                  this.onQuantityChange1(index, e.target.value, postVal)
                }
              ...
              nos <br />{" "}
              <input
                onClick={(e) => this.addItem(postVal)}
                type="button"
                style={{
                  width: 100,
                  fontSize: 12,
          ...
          <div style={{ width: "100%" }}>
            <Row>
              <Col sm={12} style={{ marginTop: 15, marginBottom: 5 }}>
                ...
                >
                  {" "}
                  Available Products For {this.state.keyVal}{" "}
                </span>
              </Col>
              ...
              <Col sm={12} style={{ marginTop: 15, marginBottom: 5 }}>
                <Card>
                  <CardBody
                    className="customise_card_body new_card"
                    style={{ padding: 18 }}
                  >
                    <MDBDataTable
                      striped
