...
class RFQ extends Component {
  ...
  goToOrderDetail(referenceNum) {
    ...
    if (window.location.href === zwzurl + "rfq") {
      axios
        .post(
          zwzapiurl + "api/rfq_history/",
      ...
      axios
        .post(
          "https://api.store.nodbearings.net/api/rfq_history/",
    ...
    return (
      <div>
        ...
        <div
          ...
          style={{ backgroundColor: "#f4f4f4", padding: 10, marginTop: 170 }}
        >
          <Row>
                ...
                >
                  <CardTitle style={{ marginBottom: 10 }}>
                    <h6 style={{ fontWeight: "bold" }}>
                      {" "}
                      Reference Number:{" "}
                      <span> {this.state.reference_num} </span>{" "}
                    </h6>
                    <h4 style={{ fontSize: 18, marginBottom: 15 }}>
                      {" "}
                      Your request has been processed. Your reference number for
                      the request is{" "}
                      <span style={{ fontWeight: "bold" }}>
                        {this.state.reference_num}{" "}
                      </span>
                      . You can contact us at <b>sales.csc@zwz.co.in</b>
                    </h4>
                    <span className="item-action" style={{ fontSize: 14 }}>
                      {" "}
                      <button
                        className="button"
                        onClick={() => this.goToRFQDetail()}
                        type="button"
                      >
                        RFI History
                      </button>{" "}
