...
class ProductCategory extends Component {
  ...
  componentDidMount() {
    if (
      window.location.hostname === "store.zwz.co.in" ||
      window.location.hostname === "localhost"
    ) {
      axios
        .post(zwzapiurl + "api/ShareItemDetails/", {
          db_type: "ZWZ",
          itemId: itemId,
        })
        .then((response) => {
      ...
      axios
        .post(
          "https://api.store.nodbearings.net/api/ShareItemDetails/",
          {
            db_type: "NOD",
            itemId: itemId,
          },
    ...
    if (
      ...
      if (this.props.isLoggedIn) {
        ...
        let itemExist = _.find(
          this.props.cart,
          (item) => item.itemcode === ProductData1.item_code
        );
                  ...
                  >
                    ...
                    >
                      ...
                      <p>
                        ...
                        <span> {this.state.country_association} </span>{" "}
                      </p>
