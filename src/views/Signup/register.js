...
class Registeraddress extends Component {
  ...
  async ResendOTP(e) {
    if (
      ...
      this.state.api_url = zwzapiurl + "authentication/mobile/otp_sent/";
    } else if (
      ...
      this.state.api_url =
        "https://api.store.nodbearings.net/authentication/mobile/otp_sent/";
    } else {
      this.state.api_url = zwzapiurl + "authentication/mobile/otp_sent/";
    }
  ...
  async onOtpSubmit(e) {
    ...
    if (
      ...
      var url =
        "https://api.store.nodbearings.net/authentication/otp/verification/";
      var api_url =
    ...
    if (response.data.success == true) {
      this.setState({
        state_options: response.data.data.map((data) => (
          <option key={data.st_id} value={data.st_id}>
            {data.st_name}
          </option>
        )),
      });
  ...
  render() {
    ...
    return (
      <div className="main_container_signup">
        ...
        <Modal isOpen={Thankyoumodal} toggle={this.Thankyoutoggle}>
          ...
          <div className="modal__body" style={{ padding: 15 }}>
            ...
            <p style={{ marginTop: "1rem" }}>
              ...
              <span
                style={{ color: "#0072bc" }}
                className="mobile_number_verification"
              >
