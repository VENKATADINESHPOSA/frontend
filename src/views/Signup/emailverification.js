...
class Emailverification extends Component {
	...
	async onclickResendemail(e){
		...
		if (window.location.href === "http://store.zwz.co.in/signup#" || window.location.href === "http://store.zwz.co.in/signup" ) {
			this.state.api_url = " http://api.store.zwz.co.in/authentication/resend_email/";
			...
			this.state.api_url = " http://api.store.nodbearings.net/authentication/resend_email/";
		}else{
			this.state.api_url = " http://api.store.zwz.co.in/authentication/resend_email/";
		}
				...
				<div className="content_container" style={{marginTop: 175}}>
					...
					<Row>
						<Col sm={12} xs={12} md={12} lg={12}>
							<div className="login_detail_container" style={{textAlign:"center"}}>
							<h2 style={{color: '#0072bc',textAlign: 'center', fontSize: '23px'}}>Email Verification</h2>
							<p style={{marginTop: '1rem'}}>This action requires email verification.</p>
							<p>Please check your inbox and follow the instruction.</p>
							   
							<p>Email sent to : <span style={{color: '#0072bc'}} className="email_for_verification">{this.state.email_verification}</span></p>
							<div className="otp_container">
								<input type="button" value="Resent Email" className="login_btn" onClick = { this.onclickResendemail } style={{width:"60%"}} />
							</div>
							</div>
						</Col>
					</Row>
