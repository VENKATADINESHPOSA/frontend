...
class ExistingCustomerSignUpForm extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    window.scrollTo(0, 0);
    const DBCompanyName = localStorage.getItem("DBCompanyName");
    this.setState({ name_of_company: DBCompanyName });
  }
      ...
      <div className="main_container_signup">
        ...
        <div className="content_container" style={{ marginTop: 175 }}>
          <Row>
            ...
            >
              <h1 className="login_title_text"> Update your account </h1>
            </Col>
            ...
            >
                  ...
                  <Row>
                    <Col sm={12} xs={12} md={12} lg={12}>
                      ...
                      <Col
                        ...
                        lg={11}
                        style={{ float: "left", padding: 0 }}
                        title="Company name field is autofilled and cannot be edited."
                      >
                        <input
                          className="form-control"
                          type="text"
                          value={this.state.name_of_company}
                        ...
                        {this.state.showError16 && (
                          <div style={{ width: "100%", textAlign: "left" }}>
                            <span style={{ color: "red", fontSize: 11 }}>
                              Company name was not autofilled. Please reach out
                              to us on sales@csc.zwz.co.in
                            </span>
                          </div>
                        )}
                      </Col>
                    ...
                    <Col sm={12} xs={12} md={12} lg={12}>
                      ...
                      >
                        <input
                          ...
                          style={{ marginBottom: "18px", marginTop: "13px" }}
                        />
              ...
              <Col
                ...
                md={4}
                lg={4}
                style={{ float: "left", paddingTop: 350, display: "none" }}
              >
...
export default ExistingCustomerSignUpForm;
