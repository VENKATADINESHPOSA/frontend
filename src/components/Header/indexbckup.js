...
class Header extends Component {
  ...
  componentWillMount() {
    ...
    /*if (window.location.href=== zwzurl || window.location.href === "https://localhost:3000/" ) {
			this.setState({
				locationUrl: false,
			})
			console.log('zwz');
		...
		} else if (window.location.href === 'https://store.nodbearings.net/login#' || window.location.href === 'https://store.nodbearings.net/login') {
			this.setState({
				locationUrl: true,
			})
			console.log('nod');
		}else if (window.location.href === zwzurl + 'home' || window.location.href==="https://localhost:3000/home#" ) {
			this.setState({
				locationUrl: false,
			})
			console.log('nod');
		}else if (window.location.href === 'https://store.nodbearings.net/home') {
			this.setState({
				locationUrl: true,
			})
			console.log('nod');
		}else if (window.location.href === zwzurl + 'product-category' || window.location.href === 'https://localhost:3000/product-category') {
			this.setState({
				locationUrl: false,
			})
			console.log('nod');
		}else if (window.location.href === 'https://store.nodbearings.net/product-category') {
			this.setState({
				locationUrl: true,
			})
			console.log('nod');
  ...
  async getCartData() {
    if (
      ...
      window.location.href.indexOf("https://localhost:3000/rfq" > -1) ||
      window.location.href.indexOf("https://localhost:3000/cart") > -1 ||
      window.location.href.indexOf("https://localhost:3000/home") > -1 ||
      window.location.href.indexOf("https://localhost:3000/order") > -1 ||
      window.location.href.indexOf("https://localhost:3000/product-category") >
        -1
    ) {
      axios
        .get(
  ...
  onHover(productVal, itemName) {
    ...
    if (
      ...
      axios
        .post(zwzapiurl + "api/display_product/", {
          item_id: productVal,
          flag: "false",
        })
        .then((response) => {
      ...
      axios
        .post("https://api.store.nodbearings.net/api/display_product/", {
  ...
  conditional_rendering() {
    ...
    if (localStorage.getItem("header_link") == "true") {
      this.state.about_href_text = (
        <a href="#" style={{ cursor: "pointer" }} className="inactive">
          {" "}
          About Us{" "}
        </a>
      );
      this.state.home_href_text = (
        <a
          ...
          className={`${
            this.props.match.path === "/home" ? "active" : "inactive"
          }`}
        >
          {" "}
          Home{" "}
      ...
      this.state.rfq_href_text = (
        <a
          href="#"
          style={{ cursor: "pointer" }}
          onClick={this.goToRFQHistory}
          className={`${
            this.props.match.path === "/rfq-history" ? "active" : "inactive"
          }`}
        >
          {" "}
          RFQ History
      ...
      this.state.myorder_href_text = (
        <a
          ...
          className={`${
            this.props.match.path === "/order-history" ? "active" : "inactive"
          }`}
        >
          {" "}
          My Orders{" "}
      ...
      if (this.props.isLoggedIn === true) {
        this.state.cart_link = (
          ...
          >
            <NotificationBadge
              style={{ top: -38 }}
              count={localStorage.getItem("num_cart_data")}
              effect={Effect.SCALE}
            />
          </i>
        );
      ...
      this.state.about_href_text = (
        <a style={{ cursor: "pointer" }} className="inactive">
          {" "}
          About Us{" "}
        </a>
      );
      this.state.home_href_text = (
        <a
          style={{ cursor: "pointer" }}
          className={`${this.props.match.path === "/" ? "active" : "inactive"}`}
        >
          {" "}
          Home{" "}
        </a>
                ...
                >
                  {this.state.zwz_search_pannel && (
                    <div className="suggestions" onClick={this.closeContainer}>
                      {this.state.data.length > 0 ? (
                        <p className="title">
                          {this.state.suggestions.length} out of{" "}
                    ...
                    <div className="recommendation">
                      ...
                      <div className="title-container">
                        <p className="title" style={{ fontSize: 15 }}>
                          You search for {this.state.itemName}{" "}
                        </p>
                      </div>
                      ...
                      {this.state.recommendation && (
                        <div className="recommended-item">
                          <span className="item-description">
                            ...
                            >
                              {" "}
                              {this.state.itemName} , {this.state.subCategory} ,{" "}
                              {this.state.category}{" "}
                            </span>
                          </span>
                  ...
                  {this.state.nod_hover_pannel && (
                    <div className="recommendation">
                      ...
                      <div className="title-container">
                        <p className="title" style={{ fontSize: 15 }}>
                          You search for {this.state.nod_item_name}{" "}
                        </p>
                      </div>
            ...
            <Col sm={8}>
              <div className="nav-container">
                <ul className="navMenu" style={{ marginBottom: 0 }}>
                  <li>{this.state.home_href_text}</li>

                  <li>{this.state.about_href_text}</li>

                  <li>{this.state.rfq_href_text}</li>

                  <li>{this.state.myorder_href_text}</li>
                </ul>
              </div>
            </Col>
            <Col sm={4}></Col>
