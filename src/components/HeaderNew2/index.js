...
class HeaderNew2 extends Component {
				...
				<div className="header-main wrapper">
					...
					<Col sm={3}>
						<div className= "user-action">
							...
							<a className="text_style" onClick={this.openLogin} href="#"> {this.state.login_details} </a>
							<span className="text_style"> / </span>
							<a style={{color: '#fff', cursor: 'pointer'}} target="_blank" className="text_style"> Logout </a>
						...
						<Col sm={8}>
							<div className="nav-container">
								<ul className="navMenu" style={{marginBottom: 0}}>
									<li>
										<a href="#" className="inactive"  onClick={this.goToHomePage}> About Us </a>
									</li>
